                  ...
                  <v-container>
                      ...
                      <v-col cols="12" sm="6">
                        ...
                        >
                          <template v-slot:selection="data">
                              {{ data.item.name }} {{ data.item.dni }}
                          </template>
                          <template v-slot:item="data">
                            <template>
                              <v-list-item-content>
                                <v-list-item-title v-html="data.item.name"></v-list-item-title>
                                <v-list-item-subtitle v-html="data.item.dni"></v-list-item-subtitle>
                              </v-list-item-content>
                            </template>
                          </template>
                        </v-autocomplete>
                    ...
                    <v-row>
                        <v-col cols="12">
                            <v-subheader class="pb-0">
                              ...
                              <span class="pb-0 dark-blue--text font-weight-bold">Ingreso &nbsp;</span>
                              <!-- (Los datos del cliente se llenaran indicando el DNI o NIT del mismo, a excepción la fecha) -->
                            </v-subheader>
                            <v-divider class="mt-0"></v-divider>                            
                        </v-col>                       
                    ...
                    <v-row>
                       <v-col cols="12" sm="6" md="6" >
                            <ValidationProvider name="Tipo de ingreso"  v-slot="{ errors }">
                                <v-autocomplete
                            ...
                            <ValidationProvider name="Monto"  rules="numeric|min_value:1" v-slot="{ errors }">
                                <v-text-field
                                    type="number"
